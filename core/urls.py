...
urlpatterns = [
    ...
    # Root da API
    path('ticket/api/', api_root, name="api-root"),

    # Apps
    path('ticket/api/', include('authentication.urls')),
    path('ticket/api/', include("catalog.urls")),
    path('ticket/api/', include("tickets.urls")),
]
